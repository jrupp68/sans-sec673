...
def process_packet(data):
    ...
    ip_layer = sniffer.protocols.IP(ip_data)
    new_packet.append(ip_layer)

    if ip_layer.parsed['ip_proto'] == 17:
        new_packet.append(sniffer.protocols.UDP(ip_layer.raw_payload))
    elif ip_layer.parsed['ip_proto'] == 1:
        new_packet.append(sniffer.protocols.ICMP(ip_layer.raw_payload))
    elif ip_layer.parsed['ip_proto'] == 6:
        new_packet.append(sniffer.protocols.TCP(ip_layer.raw_payload))
