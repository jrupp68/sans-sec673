...
class IP(Protocol):
    ...
    def process(self, bytes_in):
        ...
        self.parsed["ip_src"] = socket.inet_ntoa(
            struct.pack("!I", self.parsed["ip_src"])
        )
        self.parsed["ip_dst"] = socket.inet_ntoa(
            struct.pack("!I", self.parsed["ip_dst"])
        )
        ...
        if ip_options_length:
            ...
            self.parsed["ip_options"] = struct.unpack(
                structstring, self.raw[34 : 34 + ip_options_length]
            )
